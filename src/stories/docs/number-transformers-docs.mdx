...
<Meta title='📖 Documentation/Number Transformers' />
...
>
  ...
  <tbody>
    <tr style={{ borderBottom: '1px solid #dee2e6' }}>
      ...
      >
        <code>toFixed(2)(3.14159)</code> → <code>'3.14'</code>
      </td>
    ...
    <tr style={{ borderBottom: '1px solid #dee2e6' }}>
      ...
      <td
        style={{ padding: '12px', fontFamily: 'monospace', fontSize: '0.9em' }}
      >
        <code>parseInt('123abc')</code> → <code>123</code>
      </td>
    ...
    <tr style={{ borderBottom: '1px solid #dee2e6' }}>
      ...
      <td
        style={{ padding: '12px', fontFamily: 'monospace', fontSize: '0.9em' }}
      >
        <code>parseFloat('3.14')</code> → <code>3.14</code>
      </td>
    ...
    <tr style={{ borderBottom: '1px solid #dee2e6' }}>
      ...
      <td
        style={{ padding: '12px', fontFamily: 'monospace', fontSize: '0.9em' }}
      >
        <code>toInteger('123abc')</code> → <code>0</code>
      </td>
    ...
    <tr style={{ borderBottom: '1px solid #dee2e6' }}>
      ...
      <td
        style={{ padding: '12px', fontFamily: 'monospace', fontSize: '0.9em' }}
      >
        <code>formatCurrency()(1234.56)</code> → <code>'$1,234.56'</code>
      </td>
    ...
    <tr>
      ...
      >
        <code>formatPercentage</code>
      </td>
      <td style={{ padding: '12px' }}>Formats as percentage</td>
      <td
        style={{ padding: '12px', fontFamily: 'monospace', fontSize: '0.9em' }}
      >
        <code>formatPercentage(2)(0.1234)</code> → <code>'12.34%'</code>
      </td>
 ...
 * formatEUR(1234.56) // returns '€1,234.56'
 * ```
 */
...
formatGBP(1234.56); // "£1,234.56"
formatJPY(1234.56); // "¥1,235" (JPY doesn't use decimals)
...
EUR: formatCurrency('EUR')(price), // "€99.99"
GBP: formatCurrency('GBP')(price), // "£99.99"
...
total: formatCurrency()(price _ quantity _ (1 - discount))
};
};
